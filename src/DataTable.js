...
const DataTable = ({ refresh }) => {
  ...
  useEffect(() => {
    fetchData('https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/getAll');
  ...
  const handleDeleteRow = (id) => {
    axios.delete(`https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/delete/${id}`)
      .then(() => {
  ...
  const handleSaveEdit = () => {
    ...
    axios.put(`https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/edit/${editData.id}`, {
      ...editData,
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: '20px' }}>
                <button onClick={() => fetchData('https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/getAll')}>
                    Всі дані
                </button>
                <button onClick={() => fetchData('https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/getPositiveTemperature')}>
                    Температура більше 0
                </button>
                <button onClick={() => fetchData('https://weatherspringbootapi-aganc0dbc2hub4cg.polandcentral-01.azurewebsites.net/api/observations/getWithPrecipitation')}>
                    Присутні опади
                </button>
            </div>
